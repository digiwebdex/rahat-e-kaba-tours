#!/usr/bin/env node
/**
 * Hasan Travels - Supabase to VPS Data Migration Script
...
async function migrate() {
  ...
  try {
    ...
    const siteContent = [
      { section_key: 'about', content: {"description":"Hasan Travels has been serving pilgrims from Tangail, Bangladesh with excellence.","heading":"A Journey of","heading_highlight":"Faith & Trust","reasons":[{"desc":"Fully licensed and government-approved Hajj & Umrah agency","title":"Government Approved"},{"desc":"Dedicated support from booking to return journey","title":"Personalized Care"},{"desc":"Top-rated hotels, transport and services at every step","title":"Premium Quality"},{"desc":"Trusted service in sacred travel","title":"Experienced Team"}],"section_label":"Why Choose Us"} },
      { section_key: 'contact', content: {"email":"info@hasantravels.com.bd","heading":"Contact","heading_highlight":"Us","hours":"Sat - Thu: 9AM - 9PM","location":"৫৯৫/১, মিল্ক ভিটা রোড, তিন রাস্তার মোড, দেওলা, টাঙ্গাইল সদর, টাঙ্গাইল","phone":"+880 1711-993562","section_label":"Get In Touch"} },
      { section_key: 'footer', content: {"address":"৫৯৫/১, মিল্ক ভিটা রোড, তিন রাস্তার মোড, দেওলা, টাঙ্গাইল সদর, টাঙ্গাইল","company_name":"Hasan Travels","company_tagline":"Hajj & Umrah Services","description":"Your trusted partner for Hajj & Umrah from Tangail, Bangladesh.","developer_name":"DigiWebDex","developer_url":"https://digiwebdex.com","email":"info@hasantravels.com.bd","phone":"+880 1711-993562","services_list":["Hajj Packages","Umrah Packages","Visa Processing","Air Tickets","Hotel Booking","Ziyara Tours"]} },
