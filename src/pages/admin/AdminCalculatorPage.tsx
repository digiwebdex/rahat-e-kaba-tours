...
export default function AdminCalculatorPage() {
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      doc.text("Al Rawsha International", margin + 22, y + 13);
      ...
      doc.text("This is an estimate only. Actual costs may vary. | Al Rawsha International", pageWidth / 2, footerY, { align: "center" });
