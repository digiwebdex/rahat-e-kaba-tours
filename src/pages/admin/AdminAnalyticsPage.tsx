    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Business performance analysis</p>
        </div>
      ...
      <Tabs defaultValue="revenue" className="space-y-4">
        <TabsList className="flex flex-wrap gap-1">
          ...
          <TabsTrigger value="moallems">Middleman Performance</TabsTrigger>
        ...
        <TabsContent value="moallems" className="space-y-4">
          <Card>
            <CardHeader><CardTitle className="text-base">Middleman Performance Ranking</CardTitle></CardHeader>
            <CardContent>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
              ...
              <table className="w-full text-sm">
                <thead className="bg-muted/50">
                  <tr>
                    ...
                    <th className="text-left px-4 py-3 font-medium">Middleman</th>
                    <th className="text-center px-4 py-3 font-medium">Bookings</th>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={seasonalData}>
                    ...
                    <YAxis tick={{ fontSize: 11 }} />
                    <Tooltip />
                    <Line type="monotone" dataKey="count" name="Booking Count" stroke="#8b5cf6" strokeWidth={2} dot={{ r: 4 }} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
              <p className="text-xs text-muted-foreground mt-3 text-center">
                Showing seasonal trends aggregated across all years
              </p>
            </CardContent>
          </Card>
        </TabsContent>
