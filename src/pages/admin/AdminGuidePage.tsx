...
const AdminGuidePage = () => {
  ...
  const downloadPdf = async () => {
    ...
    try {
      ...
      pdf.text("Hasan Travels — Travel Management ERP", pageW / 2, 42, { align: "center" });
      pdf.setFontSize(9);
      ...
      SECTIONS.forEach((s, idx) => {
        ...
        pdf.text("Hasan Travels Admin Guide", pageW - 15, 9, { align: "right" });
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Hasan Travels ERP — সম্পূর্ণ admin manual। প্রতিটা module কীভাবে use করবেন step-by-step।
          </p>
        </div>
