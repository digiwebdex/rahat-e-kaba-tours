  ...
  const sections: { heading: string; body: string }[] = lc?.sections || [
    {
      ...
      body: "ট্রিপ টেস্টিক গ্রাহক সন্তুষ্টিকে সর্বোচ্চ গুরুত্ব দেয়। নিচে আমাদের রিফান্ড নীতির বিস্তারিত বর্ণনা করা হলো। অনুগ্রহ করে বুকিং করার আগে এই নীতি মনোযোগ দিয়ে পড়ুন।"
    },
    {
      heading: "সম্পূর্ণ রিফান্ড (১০০%)",
      body: "• ট্রিপ টেস্টিক-এর পক্ষ থেকে সেবা বাতিল করা হলে\n• ভিসা প্রক্রিয়ায় ট্রিপ টেস্টিক-এর ত্রুটির কারণে ভিসা না হলে\n• প্যাকেজে উল্লেখিত সেবা সম্পূর্ণরূপে প্রদান না করা হলে"
    },
    {
    ...
    },
    {
      ...
      body: "মহামারী, প্রাকৃতিক দুর্যোগ বা সরকারি নিষেধাজ্ঞার কারণে যাত্রা বাতিল হলে, ট্রিপ টেস্টিক সম্পূর্ণ রিফান্ড অথবা ভবিষ্যৎ যাত্রার জন্য ক্রেডিট প্রদান করবে। এই ক্রেডিট ১ বছরের মধ্যে ব্যবহার করতে হবে।"
    },
    {
      heading: "যোগাযোগ",
      body: "রিফান্ড সংক্রান্ত যেকোনো প্রশ্নে যোগাযোগ করুন:\nফোন: +৮৮০ ১৭১১-৯২৫৪০০\nইমেইল: info@hasantravels.com.bd\nঅফিস: ৪র্থ তলা, জেল রোড, মুন্সিপাড়া, দিনাজপুর সদর - ৫২০০"
    }
  ];
