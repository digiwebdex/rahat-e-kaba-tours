...
const Dashboard = () => {
  ...
  const getCompanyInfo = async (): Promise<CompanyInfo> => {
    ...
    return { name: "Al Rawsha International", phone: c.phone || "", email: c.email || "", address: c.location || "" };
  };
      ...
      <header className="bg-card border-b border-border sticky top-0 z-50">
        <div className="container mx-auto px-4 flex items-center justify-between h-16">
          <a href="/" className="flex items-center gap-2">
            ...
            <span className="font-heading text-lg font-bold text-primary hidden sm:block">Al Rawsha International</span>
          </a>
