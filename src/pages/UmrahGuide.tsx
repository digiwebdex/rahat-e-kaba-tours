  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Complete Umrah guideline — step-by-step rituals, requirements and travel tips from Hasan Travels."
        keywords="Umrah guide, Umrah guideline, how to perform Umrah, Hasan Travels Umrah"
      />
      <Navbar />
