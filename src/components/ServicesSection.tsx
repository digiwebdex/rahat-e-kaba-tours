...
const services: Service[] = [
  ...
  },
  {
    ...
    highlightsBn: [
      ...
      "গ্রুপ ও কর্পোরেট বুকিং",
      "ফ্লেক্সিবল ডেট পরিবর্তন",
    ],
    stats: [
      ...
      { Icon: ShieldCheck, labelEn: "Fare", labelBn: "ভাড়া", valueEn: "Best", valueBn: "সেরা" },
    ],
  },
  {
    Icon: ShieldCheck,
    ...
    highlightsBn: [
      ...
      "দূতাবাস অ্যাপয়েন্টমেন্ট",
      "আবেদনপত্র পূরণ",
      "ইন্টারভিউ প্রস্তুতি",
      "ফাস্ট-ট্র্যাক প্রসেসিং",
    ],
    stats: [
      { Icon: ShieldCheck, labelEn: "Types", labelBn: "ধরন", valueEn: "All", valueBn: "সব" },
      { Icon: MapPin, labelEn: "Countries", labelBn: "দেশ", valueEn: "30+", valueBn: "৩০+" },
      { Icon: Clock, labelEn: "Process", labelBn: "প্রসেস", valueEn: "Fast", valueBn: "দ্রুত" },
    ],
  },
];
