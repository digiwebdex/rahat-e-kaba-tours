...
const services: Service[] = [
  {
    ...
    highlightsEn: [
      "BMET approved legal recruitment",
      "3-year renewable work permit",
      "Free accommodation & meals",
      "8 hours + paid overtime",
      "Medical insurance covered",
      "Visa processing in 3–4 months",
    ],
    highlightsBn: [
      "BMET অনুমোদিত বৈধ নিয়োগ",
      "৩ বছরের নবায়নযোগ্য পারমিট",
      "ফ্রি আবাসন ও খাবার",
      "৮ ঘন্টা + পেইড ওভারটাইম",
      "মেডিকেল বীমা অন্তর্ভুক্ত",
      "৩–৪ মাসে ভিসা প্রসেসিং",
    ],
    stats: [
      { Icon: DollarSign, labelEn: "Salary", labelBn: "বেতন", valueEn: "60K–1.2L", valueBn: "৬০K–১.২L" },
      { Icon: Clock, labelEn: "Permit", labelBn: "পারমিট", valueEn: "3 Years", valueBn: "৩ বছর" },
      { Icon: MapPin, labelEn: "Country", labelBn: "দেশ", valueEn: "Fiji 🇫🇯", valueBn: "ফিজি 🇫🇯" },
    ],
  },
  {
    Icon: GraduationCap,
